...
public class DelegatingGeneratedElementProcessor extends AbstractGeneratedElementProcessor<Class<?>> {
    private List<AbstractGeneratedElementProcessor<?>> processors = new ArrayList<>();

    private DelegatingGeneratedElementProcessor() {}
    ...
    public static Builder builder() {
        return new DelegatingGeneratedElementProcessor().new Builder();
    }
    ...
    public class Builder {
        ...
        public DelegatingGeneratedElementProcessor build() {
            return DelegatingGeneratedElementProcessor.this;
        }
    }
